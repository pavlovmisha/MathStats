...
# МНК
b_mnk_clean, a_mnk_clean  = np.polyfit(x, y_clean, 1)
# МНМ
b_mnm_clean, a_mnm_clean = lad_fit(x, y_clean)
...
b_mnk_out, a_mnk_out  = np.polyfit(x, y_out, 1)
b_mnm_out, a_mnm_out  = lad_fit(x, y_out)
